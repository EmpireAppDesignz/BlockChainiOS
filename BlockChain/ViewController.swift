...
class ViewController: UIViewController {
    ...
    let firstAccount = 0021
    let secondAccount = 2018
    ...
    func transaction(from: String, to: String, amount: Int, type: String) {
        ...
        if type == "bitcoin" {
            ...
            bitcoinChain.createBitcoinBlock(data: "From: \(from); To: \(to); Amount: \(amount)BTC")
        } else if type == "normal" {
    ...
    override func viewDidLoad() {
        ...
        transaction(from: "0000", to: "\(firstAccount)", amount: 50, type: "bitcoin")
